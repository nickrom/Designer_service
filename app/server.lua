...
httpd:route({method = 'GET', path = '/', file='index.html'}, views.homepage)
    ...
    :route({method = 'GET', path = '/designer', file='designers.html'}, views.homepage)
    :route({method = 'GET', path = '/get_designers'}, api.get_all_designers)
    :route({method = 'GET', path = '/showroom', file='showrooms.html'},views.homepage)
    :route({method = 'GET', path = '/get_showrooms'}, api.get_all_showrooms)
    :route({method = 'GET', path = '/signup_designer', file='signup_designer.html'},views.homepage)
    :route({method = 'GET', path = '/signup_showroom', file='signup_showroom.html'}, views.homepage)
