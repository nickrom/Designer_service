...
local function fill_showroom()
    box.space.showroom:auto_increment{'Showroom Alisa','alisa_showroom@mail.ru', '123alisa',
        'Мы рады предложить Вам самые модные вещи от лучших частных дизайнеров Москвы',
        {'Москва', 'Измайловский бул.', '13A'}, '(499)123123', './data/showrooms/photos/1.jpg' }
    box.space.showroom:auto_increment{'Showroom Arbat', 'arbat_showroom@gmail.com', 'password1',
        'Top shoowroom in the center of Moscow',
        {'Москва', 'Арбат ул.', '12к1'}, '(495)222222', './data/showrooms/photos/2.jpg'}
end
...
local function fill_designer()
    box.space.designer:auto_increment{'George', 'gosha_rub@mail.ru', 'thebest123',
        'Gosha Rubchinkiy', '+7912331232', 'I am the best designer from Russia. My style is Modern Soviet style',
        {'Москва', 'пр. Мира', '6'}, './data/designers/photos/i.jpeg'
    }
    box.space.designer:auto_increment{'MrBob', 'bob_marley@mail.ru', 'ooooo456',
        'Bob Marley', '+79122452395', 'Reggi style',
        {'Москва', 'Бауманская ул.', '2'}, './data/designers/photos/2.jpg'
    }
end

local function fill_item()
    box.space.item:auto_increment{'Женская сиреневая рубашка', 'Модная рубашка для осени',
        {38,40,42}, 1, 39, 1500, 0, 1500, 1, {'./data/clothes/photos/1.jpg'} }
end
